...
const aboutDetailsData = [
  {
    ...
    text: "استفاده از سایت نیکاوا به منزله پذیرش کامل قوانین و مقررات آن است.کاربران موظف‌اند در تمامی مراحل خرید و استفاده از خدمات، اصول تعیین‌شده را رعایت کنندنیکاوا این حق را دارد که در صورت نیاز، مفاد قوانین را بدون اطلاع قبلی به‌روزرسانی کند.",
    id: "rules",
  },
  {
    title: "حریم خصوصی",
